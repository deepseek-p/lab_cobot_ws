---
name: robot-bringup
description: Use when configuring ROS2 robot bringup, layered launch files, ordered startup, systemd services, udev device names, watchdogs, log rotation, graceful shutdown, boot-time race conditions, or long-running robot services.
---
