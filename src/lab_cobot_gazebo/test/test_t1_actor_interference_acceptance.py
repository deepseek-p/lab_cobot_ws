#!/usr/bin/env python3
"""Strict T1 actor-interference acceptance test.

Acceptance:
  - 5 consecutive T1 runs reach DONE.
  - Each run records at least one actor avoidance metric event.
  - No recorded min_distance_m is below 0.3 m.

This intentionally uses the project one-shot bringup entry:
...
WORKSPACE = Path.home() / "lab_cobot_ws"
