...
def _run_bringup_and_cruise() -> dict:
    ...
    launch_cmd = (
        ...
        f"skip_visual_dock:=true nav_only:=true "
    ...
    try:
        ...
        status_code = "\n".join([
            ...
            "qos=QoSProfile(history=HistoryPolicy.KEEP_LAST, depth=10, reliability=ReliabilityPolicy.RELIABLE, durability=DurabilityPolicy.TRANSIENT_LOCAL)",
            "rclpy.init()",
