...
WAYPOINTS: Dict[str, Dict[str, float]] = {
    "station_a": {"x": -4.30, "y": 2.57, "yaw": math.pi / 2.0},
    "inspection_zone": {"x": 4.10, "y": 1.10, "yaw": math.pi / 2.0},
    "tooling_zone": {"x": -4.10, "y": -3.23, "yaw": math.pi / 2.0},
    "aging_zone": {"x": 0.20, "y": 2.97, "yaw": math.pi / 2.0},
    "station_b": {"x": 0.30, "y": -2.63, "yaw": math.pi / 2.0},
